...
<body onload="MM_preloadImages('http://localhost/JurdischeSpot/images/bloklinks_over.jpg','http://localhost/JurdischeSpot/images/bloklinks_over.jpg')">
<div id="mainwrapper">
  <div id="header">
    ...
    <div class="abovelist" id="menuwrapper">
      ...
      </li><a href="#">Inschrijving advocaat</a></li>
    </ul></div>
    </div>
  </div>
  <div id="strook">
...
<div id="onderheaderrechts">
  ...
  <div id="bloklinks"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Afbeelding16','','http://localhost/JurdischeSpot/images/bloklinks_over.jpg',1)"><?php echo img($image_oheaderlinks);?></a></div>
  <div id="blokbuffer"></div>
  <div id="blokrechts"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Afbeelding17','','http://localhost/JurdischeSpot/images/blokrechts_over.jpg',1)"><?php echo img($image_oheaderrechts);?></a></div>
</div>
